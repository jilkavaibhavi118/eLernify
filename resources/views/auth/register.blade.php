                        ...
                        <div class="float-card card-float pos-top-left" style="z-index: 12;">
                            <div style="display:flex; align-items:center; gap:10px;">
                                ...
                                <div>
                                    ...
                                    <div style="color:var(--text-gray); font-size:0.65rem;">Big O Notation</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        @error('name')
                            <span class="invalid-feedback" role="alert"
                                style="display:block; font-size:0.75rem; color:#ef4444; margin-top:4px;">{{ $message }}</span>
                        @enderror
                    </div>
