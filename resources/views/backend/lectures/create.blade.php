                    ...
                    <form action="{{ route('backend.lectures.store') }}" method="POST" id="crudForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="short_description"
                                        ...
                                        placeholder="Brief summary" value="{{ old('short_description') }}">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                {{ old('live_class_available', '0') == '0' ? 'checked' : '' }}>
                            ...
                            <div class="col-12 mt-3" id="zoom_fields"
                                style="{{ old('live_class_available') == '1' ? '' : 'display:none;' }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="zoom_meeting_password"
                                                        class="form-control" value="{{ old('zoom_meeting_password') }}"
